...
const LazyComponents = {
	...
	CreditCardContainer: lazy(() =>
		...
		).then((module) => ({ default: module.CreditCardContainer })),
	),
};
...
export function LazyPaymentMethodRenderer({
	...
	if (!componentEntry || !componentEntry[type]) {
		console.warn(
			`No lazy payment method ${type} component found for ${method} with provider ${provider}`,
		);
		return null;
	}
