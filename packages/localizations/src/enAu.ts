export const enAu = {
  ...
  validation: {
    ...
    enterZipCode: 'Enter a postcode',
    enterZipPostalCode: 'Enter a postcode',
    selectState: 'Select a state/territory',
  ...
  apiErrors: {
    ...
    TAX_CALCULATION_ERROR: 'GST calculation error',
    ...
    TAX_SERVICE_UNAVAILABLE: 'GST service is unavailable',
    ...
    SHIPPING_POSTAL_CODE_REQUIRED: 'Shipping postcode is required',
