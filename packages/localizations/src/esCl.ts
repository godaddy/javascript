export const esCl = {
	...
	ui: {
		...
		sidebar: {
			useSidebarError:
				"useSidebar debe ser usado dentro de un SidebarProvider.",
	...
	errors: {
		...
		useTrackingProviderError:
			"useTracking debe ser usado dentro de un TrackingProvider",
		usePoyntCollectProviderError:
			"usePoyntCollect debe ser usado dentro de un PoyntCollectProvider",
		useSquareProviderError:
			"useSquare debe ser usado dentro de un SquareProvider",
		errorProcessingPayment: "Error al procesar pago",
		stripeConfigMissing:
			"Falta configuración de Stripe. Por favor revisa tu configuración.",
		paymentSuccessful: "Pago exitoso",
		paymentFailed: "Pago falló",
		paypalConfigMissing:
			"Falta configuración de PayPal. Por favor revisa tu configuración.",
	...
	validation: {
		...
		enterValidBillingPhone:
			"Ingresa un número de teléfono de facturación válido",
	...
	apiErrors: {
		...
		DRAFT_ORDER_UPDATE_ERROR: "Error de actualización de borrador de pedido",
		DISCOUNT_APPLICATION_ERROR: "Error de aplicación de cupón",
		DRAFT_ORDER_OPEN_ERROR: "Error de apertura de borrador de pedido",
