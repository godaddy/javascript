export const esCl = {
  general: {
    ...
    closed: 'Cerrado',
    apply: 'Aplicar',
    checkoutDisabled: 'El checkout está actualmente deshabilitado. Pedimos disculpas por las molestias.',
  },
  contact: {
    title: 'Contacto',
    description: '',
  ...
  pickup: {
    ...
    description:
      'Haremos todos los esfuerzos para cumplir con el horario de retiro solicitado. Los horarios de retiro pueden variar.',
    ...
    selectTime: 'Selecciona un horario de retiro',
  ...
  delivery: {
    ...
    localPickup: 'Retiro en Tienda',
    pickupFromStore: 'Retirar en ubicación de tienda',
  },
  tips: {
  ...
  shipping: {
    ...
    lastName: 'Apellido',
    address1: 'Dirección',
    address2: 'Departamento, oficina, etc.',
    city: 'Ciudad',
    region: 'Región',
  ...
  ui: {
    ...
    form: {
      useFormFieldError: 'useFormField debe ser usado dentro de <FormField>',
    },
    pagination: {
    ...
    sidebar: {
      useSidebarError: 'useSidebar debe ser usado dentro de un SidebarProvider.',
  ...
  errors: {
    ...
    useTrackingProviderError: 'useTracking debe ser usado dentro de un TrackingProvider',
    usePoyntCollectProviderError: 'usePoyntCollect debe ser usado dentro de un PoyntCollectProvider',
    useSquareProviderError: 'useSquare debe ser usado dentro de un SquareProvider',
    errorProcessingPayment: 'Error al procesar pago',
    stripeConfigMissing: 'Falta configuración de Stripe. Por favor revisa tu configuración.',
    paymentSuccessful: 'Pago exitoso',
    paymentFailed: 'Pago falló',
    paypalConfigMissing: 'Falta configuración de PayPal. Por favor revisa tu configuración.',
    ...
    failedToInitializePayment: 'Error al inicializar pago.',
  ...
  validation: {
    ...
    phoneTooLong: 'Número de teléfono muy largo',
  ...
  apiErrors: {
    ...
    ORDER_API_NOT_FOUND: 'Fuente de datos de API de pedido no encontrada',
    DRAFT_ORDER_RETRIEVAL_FAILED: 'Error al recuperar pedido',
    DATA_SOURCES_NOT_FOUND: 'Fuentes de datos no encontradas',
    TRANSACTION_API_NOT_FOUND: 'Fuente de datos de API de transacción no encontrada',
    ...
    LINE_ITEMS_FETCH_FAILED: 'Error al obtener artículos de línea',
    ...
    TAX_CALCULATION_ERROR: 'Error de cálculo de impuesto',
    ...
    DRAFT_ORDER_UPDATE_ERROR: 'Error de actualización de pedido',
    DISCOUNT_APPLICATION_ERROR: 'Error de aplicación de cupón',
    DRAFT_ORDER_OPEN_ERROR: 'Error de apertura de pedido',
    ORDER_UPDATE_ERROR: 'Error de actualización de pedido',
