export const ptBr = {
	...
	apiErrors: {
		...
		DRAFT_ORDER_NOT_FOUND: "Rascunho do pedido não encontrado",
		...
		DRAFT_ORDER_RETRIEVAL_FAILED: "Falha ao recuperar rascunho do pedido",
		...
		DRAFT_ORDER_FETCH_FAILED: "Falha ao buscar rascunho do pedido",
		LINE_ITEMS_FETCH_FAILED: "Falha ao buscar itens de linha",
		CURRENT_ORDER_FETCH_FAILED: "Falha ao buscar rascunho do pedido atual",
		DRAFT_ORDER_UPDATE_FAILED: "Falha ao atualizar rascunho do pedido",
		...
		DRAFT_ORDER_UPDATE_ERROR: "Erro ao atualizar rascunho do pedido",
		DISCOUNT_APPLICATION_ERROR: "Erro na aplicação de cupom",
		DRAFT_ORDER_OPEN_ERROR: "Erro ao abrir rascunho do pedido",
		...
		ORDER_NOT_DRAFT: "O pedido não está em status de rascunho",
