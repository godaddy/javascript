export const esAr = {
  ...
  pickup: {
    ...
    description: 'Haremos todo lo posible para cumplir con el horario de retiro solicitado. Los horarios reales pueden variar.',
    ...
    noTimeSlots: 'No hay horarios disponibles para la fecha seleccionada. Por favor seleccioná otra fecha.',
  ...
  shipping: {
    ...
    noShippingMethodAddress: 'Ingresá tu dirección para ver los métodos de envío disponibles.',
  ...
  errors: {
    ...
    stripeConfigMissing: 'Falta configuración de Stripe. Por favor verificá tu configuración.',
    paymentSuccessful: 'Pago exitoso',
    paymentFailed: 'Error en el pago',
    paypalConfigMissing: 'Falta configuración de PayPal. Por favor verificá tu configuración.',
  ...
  validation: {
    ...
    enterValidBillingPhone: 'Ingresá un número de teléfono de facturación válido',
