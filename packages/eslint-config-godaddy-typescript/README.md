...
Configuration for ES6 React JavaScript applications using TypeScript, officially used at GoDaddy. There are many useful features:
...
These use _exactly_ the configuration defined in this  package (`eslint-config-godaddy-typescript`) **with auto-fix enabled automatically.**

``` js
{
  "scripts": {
    "lint": "eslint-godaddy-typescript files/ you/ want-to/ lint/"
  }
}
```
